...
const Hero = () => {
  ...
  return (
    <>
      <div className="bg-herobg bg-cover bg-no-repeat bg-center min-h-[95vh] px-[30px] md:px-[40px] py-[60px]">
        <div className="lg:w-[70%] mx-auto">
          <Toaster />
          <h1 className="text-white mt-[44px] lg:text-[60px] md:text-[54px] text-[36px] leading-[1.1] tracking-normal font-Epilogue font-extrabold text-center mb-[24px]">
            Find the Perfect gradient for your next projects
          </h1>
          <p className="text-[20px] font-Epilogue font-regular text-center text-[#B5C0CC] leading-[1.2]">
